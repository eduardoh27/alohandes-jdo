...
public class PersistenciaParranderos 
{
	...
	{
		return tablas.get (0); //si no es 1
	}
	...
	public String darTablaCliente() {
		return tablas.get (1); // O puede ser 2
	}
	
	public String darTablaOperador() {
		return tablas.get (2); // O puede ser 3
	}
	
	public String darTablaTipoOperadorEmpresa() {
		return tablas.get (3); // O puede ser 4
	}
	
	public String darTablaEmpresa() {
		return tablas.get (4); // O puede ser 5
	}
	
	public String darTablaTipoOperadorNatural() {
		return tablas.get (5); //si no es 6
	}
	

	public String darTablaPersonaNatural() {
		return tablas.get (6); //si no es 7
	}	
	
	public String darTablaContrato() {
		return tablas.get (7); //si no es 8
	}
	/**
	 * @return La cadena de caracteres con el nombre de la tabla de TipoMiembroComunidad de parranderos
	 */
	...
	{
		return tablas.get(11); // o 12 con secuenciador
	}
