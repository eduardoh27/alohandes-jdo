 ...
 * @author Germán Bravo
 */
public class TipoOperadorEmpresa implements VOTipoOperadorEmpresa
{
	/* ****************************************************************
	 * 			Atributos
	 *****************************************************************/
	 ...
	 */
	public TipoOperadorEmpresa(long id, String nombre) 
	{
		this.ID = id;
		this.NOMBRE = nombre;
	}
	...
	public String toString() {
		return "TipoOperadorEmpresa [ID=" + ID + ", NOMBRE=" + NOMBRE + "]";
	}
	...
	{
		TipoOperadorEmpresa tb = (TipoOperadorEmpresa) tipo;
